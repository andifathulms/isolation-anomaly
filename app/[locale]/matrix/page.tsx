...
import { LevelClasses } from '@/components/matrix/LevelClasses'
import { dictionary } from '@/lib/i18n/dictionaries'
import { metadataFor } from '@/lib/i18n/metadata'
import { LOCALES, isLocale } from '@/lib/i18n/locales'
import { levelClasses, matrixData } from '@/lib/precompute'
...
export default function MatrixPage({ params }: { params: { locale: string } }) {
  ...
  return (
    <SiteChrome locale={params.locale} active="matrix">
      ...
      {/* The matrix shows the disagreement one schedule at a time; this is what
          it adds up to across all of them. */}
      <div className="mt-16">
        <LevelClasses data={levelClasses()} dict={dict} locale={params.locale} />
      </div>
    </SiteChrome>
  )
}
